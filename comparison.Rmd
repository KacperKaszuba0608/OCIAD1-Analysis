...
mnar_prots <- which(imputed_shift.rf$missingness == 'MAR')
imputed_shift.rf[mnar_prots,1:6] <- imputed_RF[mnar_prots,]
```

```{r removing unnecessary rows}
...
```{r}
# Random Forest
imputed_RF <- imputed_RF[rows.to.keep,]
...
# K-Nearest Neighbors
imputed_kNN <- imputed_kNN[rows.to.keep,]
...
imputed_shift.rf <- imputed_shift.rf[rows.to.keep,]

# extracting KO and WT
LFQ_KO_shift.rf <- imputed_shift.rf |> dplyr::select(contains('KO'))
LFQ_WT_shift.rf <- imputed_shift.rf |> dplyr::select(contains('WT'))

miss_type <- data.frame(miss = as.character(imputed_shift.rf$missingness))
miss_type[miss_type == 'all_NA'] <- 'one_NA'
```
...
to_plot_KO23.0 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic$KO_23,
    shift.rf = LFQ_KO_shift.rf$KO.23
)
...
to_plot_KO23.1 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.standard$KO_23,
    shift.rf = LFQ_KO_shift.rf.standard$KO.23
)
...
to_plot_KO23.2 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.minmax$KO_23,
    shift.rf = LFQ_KO_shift.rf.minmax$KO.23
)
...
to_plot_KO23.3 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.med$KO_23,
    shift.rf = LFQ_KO_shift.rf.med$KO.23
)
...
to_plot_KO23.4 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.mad$KO_23,
    shift.rf = LFQ_KO_shift.rf.mad$KO.23
)
...
to_plot_KO23.5 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.lm$KO_23,
    shift.rf = LFQ_KO_shift.rf.lm$KO.23
)
...
to_plot_KO23.6 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.vsn[,2],
    shift.rf = LFQ_KO_shift.rf.vsn[,2]
)

# Prepare the data frame to plotting - EigenMS
to_plot_KO23.7 <- data.frame(
    method = 'EigenMS',
    original = LFQ_KO.eigen[,2],
    shift_dist = LFQ_KO_imp.eigen[,2],
    rf = LFQ_KO_RF.eigen[,2],
    knn = LFQ_KO_kNN.eigen[,2],
    ludovic = LFQ_KO_ludovic.eigen[,2],
    shift.rf = LFQ_KO_shift.rf.eigen[,2]
)
...
rm(to_plot_KO23.0, to_plot_KO23.1, to_plot_KO23.2, to_plot_KO23.3, to_plot_KO23.4,
   to_plot_KO23.5, to_plot_KO23.6, to_plot_KO23.7)
```
...
output$lfq.ko.23.Plot <- renderPlotly({
    ...
    filtered_data <- to_plot_KO23 |>
        ...
        tidyr::pivot_longer(2:7, names_to='Type', values_to = 'LFQ_KO_23')
...
to_plot_KO24.0 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic$KO_24,
    shift.rf = LFQ_KO_shift.rf$KO.24
)
...
to_plot_KO24.1 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.standard$KO_24,
    shift.rf = LFQ_KO_shift.rf.standard$KO.24
)
...
to_plot_KO24.2 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.minmax$KO_24,
    shift.rf = LFQ_KO_shift.rf.minmax$KO.24
)
...
to_plot_KO24.3 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.med$KO_24,
    shift.rf = LFQ_KO_shift.rf.med$KO.24
)
...
to_plot_KO24.4 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.mad$KO_24,
    shift.rf = LFQ_KO_shift.rf.mad$KO.24
)
...
to_plot_KO24.5 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.lm$KO_24,
    shift.rf = LFQ_KO_shift.rf.lm$KO.24
)
...
to_plot_KO24.6 <- data.frame(
    ...
    ludovic = LFQ_KO_ludovic.vsn[,3],
    shift.rf = LFQ_KO_shift.rf.vsn[,3]
)

# Prepare the data frame to plotting - EigenMS
to_plot_KO24.7 <- data.frame(
    method = 'EigenMS',
    original = LFQ_KO.eigen[,3],
    shift_dist = LFQ_KO_imp.eigen[,3],
    rf = LFQ_KO_RF.eigen[,3],
    knn = LFQ_KO_kNN.eigen[,3],
    ludovic = LFQ_KO_ludovic.eigen[,3],
    shift.rf = LFQ_KO_shift.rf.eigen[,3]
)
...
rm(to_plot_KO24.0, to_plot_KO24.1, to_plot_KO24.2, to_plot_KO24.3, to_plot_KO24.4,
   to_plot_KO24.5, to_plot_KO24.6, to_plot_KO24.7)
```
...
output$lfq.ko.24.Plot <- renderPlotly({
    ...
    filtered_data <- to_plot_KO24 |>
        ...
        tidyr::pivot_longer(2:7, names_to='Type', values_to = 'LFQ_KO_24')
...
to_plot_WT22.0 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic$WT_22,
    shift.rf = LFQ_WT_shift.rf$WT.22
)
...
to_plot_WT22.1 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.standard$WT_22,
    shift.rf = LFQ_WT_shift.rf.standard$WT.22
)
...
to_plot_WT22.2 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.minmax$WT_22,
    shift.rf = LFQ_WT_shift.rf.minmax$WT.22
)
...
to_plot_WT22.3 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.med$WT_22,
    shift.rf = LFQ_WT_shift.rf.med$WT.22
)
...
to_plot_WT22.4 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.mad$WT_22,
    shift.rf = LFQ_WT_shift.rf.mad$WT.22
)
...
to_plot_WT22.5 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.lm$WT_22,
    shift.rf = LFQ_WT_shift.rf.lm$WT.22
)
...
to_plot_WT22.6 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.vsn[,1],
    shift.rf = LFQ_WT_shift.rf.vsn[,1]
)

# Prepare the data frame to plotting - EigenMS
to_plot_WT22.7 <- data.frame(
    method = 'EigenMS',
    original = LFQ_WT.eigen[,1],
    shift_dist = LFQ_WT_imp.eigen[,1],
    rf = LFQ_WT_RF.eigen[,1],
    knn = LFQ_WT_kNN.eigen[,1],
    ludovic = LFQ_WT_ludovic.eigen[,1],
    shift.rf = LFQ_WT_shift.rf.eigen[,1]
)
...
rm(to_plot_WT22.0, to_plot_WT22.1, to_plot_WT22.2, to_plot_WT22.3, to_plot_WT22.4,
   to_plot_WT22.5, to_plot_WT22.6, to_plot_WT22.7)
```
...
output$lfq.WT.22.Plot <- renderPlotly({
    ...
    filtered_data <- to_plot_WT22 |>
        ...
        tidyr::pivot_longer(2:7, names_to='Type', values_to = 'LFQ_WT_22')
...
to_plot_WT23.0 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic$WT_23,
    shift.rf = LFQ_WT_shift.rf$WT.23
)
...
to_plot_WT23.1 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.standard$WT_23,
    shift.rf = LFQ_WT_shift.rf.standard$WT.23
)
...
to_plot_WT23.2 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.minmax$WT_23,
    shift.rf = LFQ_WT_shift.rf.minmax$WT.23
)
...
to_plot_WT23.3 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.med$WT_23,
    shift.rf = LFQ_WT_shift.rf.med$WT.23
)
...
to_plot_WT23.4 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.mad$WT_23,
    shift.rf = LFQ_WT_shift.rf.mad$WT.23
)
...
to_plot_WT23.5 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.lm$WT_23,
    shift.rf = LFQ_WT_shift.rf.lm$WT.23
)
...
to_plot_WT23.6 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.vsn[,2],
    shift.rf = LFQ_WT_shift.rf.vsn[,2]
)

# Prepare the data frame to plotting - EigenMS
to_plot_WT23.7 <- data.frame(
    method = 'EigenMS',
    original = LFQ_WT.eigen[,2],
    shift_dist = LFQ_WT_imp.eigen[,2],
    rf = LFQ_WT_RF.eigen[,2],
    knn = LFQ_WT_kNN.eigen[,2],
    ludovic = LFQ_WT_ludovic.eigen[,2],
    shift.rf = LFQ_WT_shift.rf.eigen[,2]
)
...
rm(to_plot_WT23.0, to_plot_WT23.1, to_plot_WT23.2, to_plot_WT23.3, to_plot_WT23.4,
   to_plot_WT23.5, to_plot_WT23.6, to_plot_WT23.7)
```
...
output$lfq.WT.23.Plot <- renderPlotly({
    ...
    filtered_data <- to_plot_WT23 |>
        ...
        tidyr::pivot_longer(2:7, names_to='Type', values_to = 'LFQ_WT_23')
...
to_plot_WT24.0 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic$WT_24,
    shift.rf = LFQ_WT_shift.rf$WT.24
)
...
to_plot_WT24.1 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.standard$WT_24,
    shift.rf = LFQ_WT_shift.rf.standard$WT.24
)
...
to_plot_WT24.2 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.minmax$WT_24,
    shift.rf = LFQ_WT_shift.rf.minmax$WT.24
)
...
to_plot_WT24.3 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.med$WT_24,
    shift.rf = LFQ_WT_shift.rf.med$WT.24
)
...
to_plot_WT24.4 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.mad$WT_24,
    shift.rf = LFQ_WT_shift.rf.mad$WT.24
)
...
to_plot_WT24.5 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.lm$WT_24,
    shift.rf = LFQ_WT_shift.rf.lm$WT.24
)
...
to_plot_WT24.6 <- data.frame(
    ...
    ludovic = LFQ_WT_ludovic.vsn[,3],
    shift.rf = LFQ_WT_shift.rf.vsn[,3]
)

# Prepare the data frame to plotting - EigenMS
to_plot_WT24.7 <- data.frame(
    method = 'EigenMS',
    original = LFQ_WT.eigen[,3],
    shift_dist = LFQ_WT_imp.eigen[,3],
    rf = LFQ_WT_RF.eigen[,3],
    knn = LFQ_WT_kNN.eigen[,3],
    ludovic = LFQ_WT_ludovic.eigen[,3],
    shift.rf = LFQ_WT_shift.rf.eigen[,3]
)
...
rm(to_plot_WT24.0, to_plot_WT24.1, to_plot_WT24.2, to_plot_WT24.3, to_plot_WT24.4,
   to_plot_WT24.5, to_plot_WT24.6, to_plot_WT24.7)
```
...
output$lfq.WT.24.Plot <- renderPlotly({
    ...
    filtered_data <- to_plot_WT24 |>
        ...
        tidyr::pivot_longer(2:7, names_to='Type', values_to = 'LFQ_WT_24')
...
to_plot_all <- rbind(to_plot_KO22,
                     ...
                     to_plot_KO24,
                     to_plot_WT23)
to_plot_all$celltype <- rep(c('KO.22', 'WT.22', 'KO.23', 'WT.23', 'KO.24', 'WT.24'), each = nrow(to_plot_KO22))
```
...
```{r}
shiny::selectInput('data_type', 'Select the type of data:', colnames(to_plot_all)[2:7])
```
...
output$lfq.all.Plot <- renderPlotly({
    ...
    filtered_data <- to_plot_all |>
        tidyr::pivot_longer(2:7, names_to='Type', values_to = 'LFQ') |>
        dplyr::filter(celltype == selected_cell & Type == selected_data)
    
    plotly::plot_ly(data = filtered_data, x = ~LFQ, split = ~method,
                    type = 'histogram', opacity = 0.5, histfunc = 'count', xbins = 20) |>
        plotly::layout(
...
```{r}
shiny::selectInput('replicate', 'Select the replicate of sample:', c('22','23','24'))
```
...
```{r}
shiny::selectInput('data_type2', 'Select the type of data:', colnames(to_plot_all)[2:7])
```
...
```{r}
shiny::selectInput('method7', 'Select the Normalization Method:', unique(to_plot_all$method))
```
...
```{r}
output$ko.vs.wt <- renderPlotly({
    selected_rep <- input$replicate
    selected_data_type <- input$data_type2
    selected_method <- input$method7
    
    # Filter data for selected_rep
    filtered_data <- to_plot_all[grep(selected_rep, to_plot_all$celltype), ] |>
        tidyr::pivot_longer(2:7, names_to = 'Type', values_to = 'LFQ') |> 
        dplyr::filter(method == selected_method & Type == selected_data_type)
    
    plotly::plot_ly(data = filtered_data, x = ~LFQ, color = ~celltype,
                    type = 'histogram', opacity = 0.5, histfunc = 'count', xbins = 20) |>
        plotly::layout(
            title = paste('Distributions of the', selected_rep, 'replicates - KO VS WT:', selected_method),
            xaxis = list(title=paste('LFQ', selected_rep)),
            yaxis = list(title='Frequency'),
            barmode = 'overlay'
        )
})
...
#### SHIFT DIST + RF ####
cv_shift.rf_summary_KO <- cv_shift.rf_all |>   # calculating basic statistics for KO
    select(contains('KO')) |>
    pivot_longer(everything(), names_to = 'method KO', values_to = 'LFQ_CV') |>
    group_by(`method KO`) |>
    summarise('mean_KO'=round(mean(LFQ_CV, na.rm=TRUE),5), 
...
cv_shift.rf_summary_WT <- cv_shift.rf_all |>   # calculating basic statistics for WT
    select(contains('WT')) |>
    pivot_longer(everything(), names_to = 'method WT', values_to = 'LFQ_CV') |>
    group_by(`method WT`) |>
    summarise('mean_WT'=round(mean(LFQ_CV, na.rm=TRUE),5), 
...
# prepare more readable output - Shift Dist + RF
cv_shift.rf_summary <- as.data.frame(cbind(cv_shift.rf_summary_KO, cv_shift.rf_summary_WT[-1]))
colnames(cv_shift.rf_summary)[1] <- 'method'
cv_shift.rf_summary$method <- gsub('_KO', '', cv_shift.rf_summary$method)
```
...
```{r}
show_cv_table(cv_shift.rf_summary)
```
...
```{r ICC6}
# Calculate ICC for Imputed KO data using ludovic
icc_shift.rf.KO.before <- irr::icc(2^LFQ_KO_shift.rf)$value
icc_shift.rf.KO.standard <- irr::icc(2^LFQ_KO_shift.rf.standard)$value
icc_shift.rf.KO.minmax <- irr::icc(2^LFQ_KO_shift.rf.minmax)$value
icc_shift.rf.KO.med <- irr::icc(2^LFQ_KO_shift.rf.med)$value
icc_shift.rf.KO.mad <- irr::icc(2^LFQ_KO_shift.rf.mad)$value
icc_shift.rf.KO.lm <- irr::icc(2^LFQ_KO_shift.rf.lm)$value
icc_shift.rf.KO.vsn <- irr::icc(2^LFQ_KO_shift.rf.vsn)$value
icc_shift.rf.KO.eig <- irr::icc(2^LFQ_KO_shift.rf.eigen)$value

# Bind all calculated ICCs to a data frame
icc_shift.rf.KO.all <- data.frame(`ICC KO`=c(icc_shift.rf.KO.before, icc_shift.rf.KO.standard,
                                            icc_shift.rf.KO.minmax, icc_shift.rf.KO.med, 
                                            icc_shift.rf.KO.mad, icc_shift.rf.KO.lm, 
                                            icc_shift.rf.KO.vsn, icc_shift.rf.KO.eig))
rownames(icc_shift.rf.KO.all) <- c('Before', 'Z-score', 'MinMax', 'Median', 'MAD', 'Linear', 
                       'VSN', 'EigenMS')

# Calculate ICC for Imputed KO data using shift.rf
icc_shift.rf.WT.before <- irr::icc(2^LFQ_WT_shift.rf)$value
icc_shift.rf.WT.standard <- irr::icc(2^LFQ_WT_shift.rf.standard)$value
icc_shift.rf.WT.minmax <- irr::icc(2^LFQ_WT_shift.rf.minmax)$value
icc_shift.rf.WT.med <- irr::icc(2^LFQ_WT_shift.rf.med)$value
icc_shift.rf.WT.mad <- irr::icc(2^LFQ_WT_shift.rf.mad)$value
icc_shift.rf.WT.lm <- irr::icc(2^LFQ_WT_shift.rf.lm)$value
icc_shift.rf.WT.vsn <- irr::icc(2^LFQ_WT_shift.rf.vsn)$value
icc_shift.rf.WT.eig <- irr::icc(2^LFQ_WT_shift.rf.eigen)$value

# Bind all calculated ICCs to a data frame
icc_shift.rf.WT.all <- data.frame(`ICC WT`=c(icc_shift.rf.WT.before, icc_shift.rf.WT.standard, 
                                            icc_shift.rf.WT.minmax, icc_shift.rf.WT.med, 
                                            icc_shift.rf.WT.mad, icc_shift.rf.WT.lm, 
                                            icc_shift.rf.WT.vsn, icc_shift.rf.WT.eig))
rownames(icc_shift.rf.WT.all) <- c('Before', 'Z-score', 'MinMax', 'Median', 'MAD', 'Linear', 
                       'VSN', 'EigenMS')

# Show the table in a nice format
DT::datatable(cbind(icc_shift.rf.KO.all, icc_shift.rf.WT.all), 
              options=list(searching=FALSE, paging=FALSE, info=FALSE)) |>
    DT::formatStyle(columns = c('ICC.KO', 'ICC.WT'), 
                    background = DT::styleInterval(c(0.5,0.75,0.9), c('#D3D3D3', '#aefda1', '#6dff54', '#1bb400')))
```
...
```{r p-value 0.06 shift.rf data}
# calculate the p-values for our data
pvalue_shift.rf <- imputed_shift.rf |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(imputed_shift.rf, 1, ttest, 
                  grp1=grep("KO", colnames(imputed_shift.rf)), 
                  grp2=grep("WT", colnames(imputed_shift.rf)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE)) # add a significance column 
m <- mean(pvalue_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # mean of p
me <- median(pvalue_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # median of p

# Plotting the histogram of the p-values filled with a significance info
hist_p_shift.rf <- ggplot(data = pvalue_shift.rf, aes(x = p_OCIAD1_TOTALS, fill=significant)) + 
    geom_histogram(bins = 100) + ggtitle('Imputed Shift Dist & RF - p.value') + theme(legend.position = 'none') +
    annotate("text", x = Inf, y = Inf, label = paste("μ(p) =", round(m, 3), '\nmed(p) =', round(me,3)), 
             hjust = 1.1, vjust = 1.3, size = 3.5, color = "black")
```
...
```{r p-value 0.06 raw data standardization}
# prepare data for t-test
standard_df <- data.frame(LFQ_KO.standard, LFQ_WT.standard)
standard_df <- standard_df[-which(miss_type$miss == 'MNAR'),]
...
```{r p-value 0.06 imputed data standardization}
# prepare data for t-test
...
```{r p-value 0.06 rf data standardization}
# prepare data for t-test
...
```{r p-value 0.06 kNN data standardization}
# prepare data for t-test
...
```{r p-value 0.06 ludovic data standardization}
# prepare data for t-test
...
```{r p-value 0.06 shift.rf data standardization}
# prepare data for t-test
standard_df_shift.rf <- data.frame(LFQ_KO_shift.rf.standard, LFQ_WT_shift.rf.standard)

# calculate the p-values for our data
pvalue_standard_shift.rf <- standard_df_shift.rf |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(standard_df_shift.rf, 1, ttest, 
                  grp1=grep("KO", colnames(standard_df_shift.rf)), 
                  grp2=grep("WT", colnames(standard_df_shift.rf)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE)) # add a significance column 
m <- mean(pvalue_standard_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # mean of p
me <- median(pvalue_standard_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # median of p

# Plotting the histogram of the p-values filled with a significance info
hist_p_standard_shift.rf <- ggplot(data = pvalue_standard_shift.rf, aes(x = p_OCIAD1_TOTALS, fill=significant)) + 
    geom_histogram(bins = 100) + ggtitle('Imputed Shift Dist & RF - p.value') + theme(legend.position = 'none') +
    annotate("text", x = Inf, y = Inf, label = paste("μ(p) =", round(m, 3), '\nmed(p) =', round(me,3)), 
             hjust = 1.1, vjust = 1.3, size = 3.5, color = "black")
```
...
```{r p-value 0.06 raw data minmax}
# prepare data for t-test
minmax_df <- data.frame(LFQ_KO.minmax, LFQ_WT.minmax)
minmax_df <- minmax_df[-which(miss_type$miss == 'MNAR'),]
...
```{r p-value 0.06 imputed data minmax}
# prepare data for t-test
...
```{r p-value 0.06 kNN data minmax}
# prepare data for t-test
...
```{r p-value 0.06 ludovic data minmax}
# prepare data for t-test
...
```{r p-value 0.06 shift.rf data minmax}
# prepare data for t-test
minmax_df_shift.rf <- data.frame(LFQ_KO_shift.rf.minmax, LFQ_WT_shift.rf.minmax)

# calculate the p-values for our data
pvalue_minmax_shift.rf <- minmax_df_shift.rf |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(minmax_df_shift.rf, 1, ttest, 
                  grp1=grep("KO", colnames(minmax_df_shift.rf)), 
                  grp2=grep("WT", colnames(minmax_df_shift.rf)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE)) # add a significance column 
m <- mean(pvalue_minmax_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # mean of p
me <- median(pvalue_minmax_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # median of p

# Plotting the histogram of the p-values filled with a significance info
hist_p_minmax_shift.rf <- ggplot(data = pvalue_minmax_shift.rf, aes(x = p_OCIAD1_TOTALS, fill=significant)) + 
    geom_histogram(bins = 100) + ggtitle('Imputed Shift Dist & RF - p.value') + theme(legend.position = 'none') +
    annotate("text", x = Inf, y = Inf, label = paste("μ(p) =", round(m, 3), '\nmed(p) =', round(me,3)), 
             hjust = 1.1, vjust = 1.3, size = 3.5, color = "black")
```
...
```{r p-value 0.06 raw data median}
# prepare data for t-test
med_df <- data.frame(LFQ_KO.med, LFQ_WT.med)
med_df <- med_df[-which(miss_type$miss == 'MNAR'),]
...
```{r p-value 0.06 imputed data median}
# prepare data for t-test
...
```{r p-value 0.06 kNN data median}
# prepare data for t-test
...
```{r p-value 0.06 ludovic data median}
# prepare data for t-test
...
```{r p-value 0.06 shift.rf data median}
# prepare data for t-test
med_df_shift.rf <- data.frame(LFQ_KO_shift.rf.med, LFQ_WT_shift.rf.med)

# calculate the p-values for our data
pvalue_med_shift.rf <- med_df_shift.rf |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(med_df_shift.rf, 1, ttest, 
                  grp1=grep("KO", colnames(med_df_shift.rf)), 
                  grp2=grep("WT", colnames(med_df_shift.rf)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE)) # add a significance column 
m <- mean(pvalue_med_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # mean of p
me <- median(pvalue_med_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # median of p

# Plotting the histogram of the p-values filled with a significance info
hist_p_med_shift.rf <- ggplot(data = pvalue_med_shift.rf, aes(x = p_OCIAD1_TOTALS, fill=significant)) + 
    geom_histogram(bins = 100) + ggtitle('Imputed Shift Dist & RF - p.value') + theme(legend.position = 'none') +
    annotate("text", x = Inf, y = Inf, label = paste("μ(p) =", round(m, 3), '\nmed(p) =', round(me,3)), 
             hjust = 1.1, vjust = 1.3, size = 3.5, color = "black")
```
...
```{r p-value 0.06 raw data mad}
# prepare data for t-test
mad_df <- data.frame(LFQ_KO.mad, LFQ_WT.mad)
mad_df <- mad_df[-which(miss_type$miss == 'MNAR'),]
...
```{r p-value 0.06 imputed data mad}
# prepare data for t-test
...
```{r p-value 0.06 ludovic data mad}
# prepare data for t-test
...
```{r p-value 0.06 shift.rf data mad}
# prepare data for t-test
mad_df_shift.rf <- data.frame(LFQ_KO_shift.rf.mad, LFQ_WT_shift.rf.mad)

# calculate the p-values for our data
pvalue_mad_shift.rf <- mad_df_shift.rf |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(mad_df_shift.rf, 1, ttest, 
                  grp1=grep("KO", colnames(mad_df_shift.rf)), 
                  grp2=grep("WT", colnames(mad_df_shift.rf)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE)) # add a significance column
m <- mean(pvalue_mad_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # mean of p
me <- median(pvalue_mad_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # median of p

# Plotting the histogram of the p-values filled with a significance info
hist_p_mad_shift.rf <- ggplot(data = pvalue_mad_shift.rf, aes(x = p_OCIAD1_TOTALS, fill=significant)) + 
    geom_histogram(bins = 100) + ggtitle('Imputed Shift Dist & RF - p.value') + theme(legend.position = 'none') +
    annotate("text", x = Inf, y = Inf, label = paste("μ(p) =", round(m, 3), '\nmed(p) =', round(me,3)), 
             hjust = 1.1, vjust = 1.3, size = 3.5, color = "black")
```
...
```{r p-value 0.06 raw data lm}
# prepare data for t-test
lm_df <- data.frame(LFQ_KO.lm, LFQ_WT.lm)
lm_df <- lm_df[-which(miss_type$miss == 'MNAR'),]
...
```{r p-value 0.06 imputed data lm}
# prepare data for t-test
...
```{r p-value 0.06 ludovic data lm}
# prepare data for t-test
...
```{r p-value 0.06 shift.rf data lm}
# prepare data for t-test
lm_df_shift.rf <- data.frame(LFQ_KO_shift.rf.lm, LFQ_WT_shift.rf.lm)

# calculate the p-values for our data
pvalue_lm_shift.rf <- lm_df_shift.rf |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(lm_df_shift.rf, 1, ttest, 
                  grp1=grep("KO", colnames(lm_df_shift.rf)), 
                  grp2=grep("WT", colnames(lm_df_shift.rf)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE)) # add a significance column
m <- mean(pvalue_lm_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # mean of p
me <- median(pvalue_lm_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # median of p

# Plotting the histogram of the p-values filled with a significance info
hist_p_lm_shift.rf <- ggplot(data = pvalue_lm_shift.rf, aes(x = p_OCIAD1_TOTALS, fill=significant)) + 
    geom_histogram(bins = 100) + ggtitle('Imputed Shift Dist & RF - p.value') + theme(legend.position = 'none') +
    annotate("text", x = Inf, y = Inf, label = paste("μ(p) =", round(m, 3), '\nmed(p) =', round(me,3)), 
             hjust = 1.1, vjust = 1.3, size = 3.5, color = "black")
```
...
```{r p-value 0.06 raw data vsn}
# prepare data for t-test
vsn_df <- data.frame(LFQ_KO.vsn, LFQ_WT.vsn)
vsn_df <- vsn_df[-which(miss_type$miss == 'MNAR'),]
...
```{r p-value 0.06 imputed data vsn}
# prepare data for t-test
...
```{r p-value 0.06 ludovic data vsn}
# prepare data for t-test
...
```{r p-value 0.06 shift.rf data vsn}
# prepare data for t-test
vsn_df_shift.rf <- data.frame(LFQ_KO_shift.rf.vsn, LFQ_WT_shift.rf.vsn)

# calculate the p-values for our data
pvalue_vsn_shift.rf <- vsn_df_shift.rf |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(vsn_df_shift.rf, 1, ttest, 
                  grp1=grep("KO", colnames(vsn_df_shift.rf)), 
                  grp2=grep("WT", colnames(vsn_df_shift.rf)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE)) # add a significance column
m <- mean(pvalue_vsn_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # mean of p
me <- median(pvalue_vsn_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # median of p

# Plotting the histogram of the p-values filled with a significance info
hist_p_vsn_shift.rf <- ggplot(data = pvalue_vsn_shift.rf, aes(x = p_OCIAD1_TOTALS, fill=significant)) + 
    geom_histogram(bins = 100) + ggtitle('Imputed Shift Dist & RF - p.value') + theme(legend.position = 'none') +
    annotate("text", x = Inf, y = Inf, label = paste("μ(p) =", round(m, 3), '\nmed(p) =', round(me,3)), 
             hjust = 1.1, vjust = 1.3, size = 3.5, color = "black")
```
...
```{r p-value 0.06 raw data eigen}
# prepare data for t-test
eigen_df1 <- data.frame(LFQ_KO.eigen, LFQ_WT.eigen)
...
```{r p-value 0.06 imputed data eigen}
# prepare data for t-test
...
```{r p-value 0.06 ludovic data eigen}
# prepare data for t-test
...
```{r p-value 0.06 shift.rf data eigen}
# prepare data for t-test
eigen_df_shift.rf <- data.frame(LFQ_KO_shift.rf.eigen, LFQ_WT_shift.rf.eigen)

# calculate the p-values for our data
pvalue_eigen_shift.rf <- eigen_df_shift.rf |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(eigen_df_shift.rf, 1, ttest, 
                  grp1=grep("KO", colnames(eigen_df_shift.rf)), 
                  grp2=grep("WT", colnames(eigen_df_shift.rf)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE)) # add a significance column
m <- mean(pvalue_eigen_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # mean of p
me <- median(pvalue_eigen_shift.rf$p_OCIAD1_TOTALS, na.rm=TRUE) # median of p

# Plotting the histogram of the p-values filled with a significance info
hist_p_eigen_shift.rf <- ggplot(data = pvalue_eigen_shift.rf, aes(x = p_OCIAD1_TOTALS, fill=significant)) + 
    geom_histogram(bins = 100) + ggtitle('Imputed Shift Dist & RF - p.value') + theme(legend.position = 'none') +
    annotate("text", x = Inf, y = Inf, label = paste("μ(p) =", round(m, 3), '\nmed(p) =', round(me,3)), 
             hjust = 1.1, vjust = 1.3, size = 3.5, color = "black")
```
...
pvalue_kNN <- df_kNN |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(df_kNN, 1, ttest, 
                  ...
                  grp2=grep("WT", colnames(df_kNN)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE),
                  protein.ids = protein.groups$`Protein IDs`[rows.to.keep][-duplicates]) # add a significance column 
m <- mean(pvalue_kNN$p_OCIAD1_TOTALS, na.rm=TRUE) # mean of p
me <- median(pvalue_kNN$p_OCIAD1_TOTALS, na.rm=TRUE) # median of p
...
```{r p-value shift.rf data standardization}
# prepare data for t-test
standard_df_shift.rf <- data.frame(LFQ_KO_shift.rf.standard, LFQ_WT_shift.rf.standard)
...
```{r p-value shift.rf data minmax}
# prepare data for t-test
minmax_df_shift.rf <- data.frame(LFQ_KO_shift.rf.minmax, LFQ_WT_shift.rf.minmax)
...
```{r p-value shift.rf data median}
# prepare data for t-test
med_df_shift.rf <- data.frame(LFQ_KO_shift.rf.med, LFQ_WT_shift.rf.med)
...
# prepare data for t-test
eigen_df_imp <- cbind.data.frame(LFQ_KO_imp.eigen, LFQ_WT_imp.eigen)
...
# prepare data for t-test
eigen_df_RF <- cbind.data.frame(LFQ_KO_RF.eigen, LFQ_WT_RF.eigen)
...
# prepare data for t-test
eigen_df_kNN <- cbind.data.frame(LFQ_KO_kNN.eigen, LFQ_WT_kNN.eigen)
...
```{r p-value shift.rf data eigen}
# prepare data for t-test
eigen_df_shift.rf <- cbind.data.frame(LFQ_KO_shift.rf.eigen, LFQ_WT_shift.rf.eigen)
...
data <- data.frame(
    ...
    imputed_shift.rf[,1:6] |>
        tidyr::pivot_longer(cols=everything(), names_to = 'Batch7', values_to = 'Shift.RF'),
    as_tibble(LFQ_shift.rf.eig_norm$norm_m) |> 
        tidyr::pivot_longer(cols=everything(), names_to = 'Batch8', values_to = 'Eigen.Shift.RF')
) |>
    dplyr::select(Gene_Name, Batch, Raw, Eigen.Raw, RF, Eigen.RF, Ludovic, Eigen.Ludovic, Shift.RF, Eigen.Shift.RF)
...
output$genePlot <- renderPlotly({
  ...
  plot_ly(data = filtered_data, type = "bar") |>
      ...
      add_trace(x = ~Batch, y = ~Shift.RF, name = 'Shift Dist & RF') |>
      add_trace(x = ~Batch, y = ~Eigen.Shift.RF, name = 'Eigen Shift\nDist & RF') |>
      layout(
...
output$genePlotunlogged <- renderPlotly({
  ...
  plot_ly(data = filtered_data, type = "bar") |>
      ...
      add_trace(x = ~Batch, y = ~Eigen.Shift.RF, name = 'Eigen Shift\nDist & RF') |>
      layout(
      title = paste("Bar Plot for Gene:", selected_gene, '- unlogged data'),
      xaxis = list(title = NULL),
...
```{r}
miss_type$protein.ids <- protein.groups$`Protein IDs`[rows.to.keep]
```
...
lfq5 <- cbind.data.frame(lfq, protein.ids=protein.groups$`Protein IDs`[rows.to.keep],
...
```{r fc imp data}
# Preparing data for calculations
lfq_imp <- cbind.data.frame(lfq_imp, protein.ids=protein.groups$`Protein IDs`[rows.to.keep],
                            gene = protein.groups$`Gene names`[rows.to.keep])
...
# Preparing data for volcano plot
FC <- merge(means, lfq_imp, by = 'protein.ids')

to_volcano2 <- merge(FC,pvalue_imp, by = 'protein.ids')
...
output$V2 <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = paste('Volcano plot for Imputed Data Shift Dist -', p.type),
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = paste('-log10(',p.type,')', sep='')),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
...
```{r fc RF data}
# Preparing data for calculations
imputed_RF <- cbind.data.frame(imputed_RF, protein.ids=protein.groups$`Protein IDs`[rows.to.keep],
                               gene = protein.groups$`Gene names`[rows.to.keep])
...
# Preparing data for volcano plot
FC <- merge(means, imputed_RF, by = 'protein.ids')

to_volcano3 <- merge(FC, pvalue_RF, by = 'protein.ids')
...
output$V3 <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         hoverinfo = list('text', 'symbol'),  # Show labels on hover
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = paste('Volcano plot for Imputed Data RF -', p.type),
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = paste('-log10(',p.type,')', sep='')),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
...
```{r fc kNN data}
# Preparing data for calculations
imputed_kNN <- cbind.data.frame(imputed_kNN, protein.ids=protein.groups$`Protein IDs`[rows.to.keep],
                                gene = protein.groups$`Gene names`[rows.to.keep])
...
# Preparing data for volcano plot
FC <- merge(means, imputed_kNN, by = 'protein.ids')

to_volcano4 <- merge(FC, pvalue_kNN, by = 'protein.ids')
...
output$V4 <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         hoverinfo = list('text', 'symbol'),  # Show labels on hover
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = paste('Volcano plot for Imputed Data kNN -', p.type),
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = paste('-log10(',p.type,')', sep='')),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
...
```{r fc shift.rf data}
# Preparing data for calculations
imputed_shift.rf0 <- cbind.data.frame(imputed_shift.rf[,1:6], 
                                    protein.ids=protein.groups$`Protein IDs`[rows.to.keep],
                                    gene = protein.groups$`Gene names`[rows.to.keep])
imputed_long_shift.rf <- imputed_shift.rf0 |>
    tidyr::pivot_longer(1:6, names_to = 'sample', values_to = 'LFQvalue')

# Add a new column with groups KO or WT
imputed_long_shift.rf$group <- 'TOTALS_OCIAD1_KO'
imputed_long_shift.rf$group[grep('WT',imputed_long_shift.rf$sample)] <- 'TOTALS_OCIAD1_WT'

# Calculation of means for groups KO and WT
means <- imputed_long_shift.rf |>
    dplyr::group_by(group, protein.ids) |>
    dplyr::summarise(mean=mean(LFQvalue, na.rm=TRUE)) |>
    dplyr::ungroup()
...
# Preparing data for volcano plot
FC <- merge(means, imputed_shift.rf0, by = 'protein.ids')

to_volcano6 <- merge(FC, pvalue_shift.rf, by = 'protein.ids')
...
output$V6 <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         hoverinfo = list('text', 'symbol'),  # Show labels on hover
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = paste('Volcano plot for Imputed Data Shift Dist & RF -', p.type),
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = paste('-log10(',p.type,')', sep='')),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
...
```{r fc eigen imp data}
# Preparing data for calculations
eigen_df_imp <- cbind.data.frame(eigen_df_imp, protein.ids=protein.groups$`Protein IDs`[rows.to.keep],
                                 gene = protein.groups$`Gene names`[rows.to.keep])
...
# Preparing data for volcano plot
FC <- merge(means, eigen_df_imp, by = 'protein.ids')

to_volcano8 <- merge(FC, pvalue_eigen_imp, by = 'protein.ids')
...
```{r fc eigen RF data}
# Preparing data for calculations
eigen_df_RF <- cbind.data.frame(eigen_df_RF, protein.ids=protein.groups$`Protein IDs`[rows.to.keep],
                                gene = protein.groups$`Gene names`[rows.to.keep])
...
# Preparing data for volcano plot
FC <- merge(means, eigen_df_RF, by = 'protein.ids')

to_volcano9 <- merge(FC, pvalue_eigen_RF, by = 'protein.ids')
...
output$V3eig <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         hoverinfo = list('text', 'symbol'),  # Show gene labels on hover
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = paste('Volcano plot for Non-Imputed Data Random Forest -', p.type),
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = paste('-log10(',p.type,')', sep='')),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
    ...
    if (length(selected_row) != 0) {
        v <- v |> add_markers(data = sel_gene_data, 
                               ...
                               marker = list(color = 'brown', size = 10),
                               inherit = FALSE,
                               name = selected_gene)  # Make sure these points stand out
    }
...
```{r fc eigen kNN data}
# Preparing data for calculations
eigen_df_kNN <- cbind.data.frame(eigen_df_kNN, protein.ids=protein.groups$`Protein IDs`[rows.to.keep],
                                 gene = protein.groups$`Gene names`[rows.to.keep])
...
# Preparing data for volcano plot
FC <- merge(means, eigen_df_kNN, by = 'protein.ids')

to_volcano10 <- merge(FC, pvalue_eigen_kNN, by = 'protein.ids')
...
output$V4eig <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         hoverinfo = list('text', 'symbol'),  # Show labels on hover
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = paste('Volcano plot for Imputed Data k-Nearest Neighbors -', p.type),
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = paste('-log10(',p.type,')', sep='')),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
...
```{r fc eigen shift.rf data}
# Preparing data for calculations
eigen_df_shift.rf1 <- cbind.data.frame(eigen_df_shift.rf, 
                                     protein.ids=protein.groups$`Protein IDs`[rows.to.keep],
                                     gene = protein.groups$`Gene names`[rows.to.keep])
eigen_df_long_shift.rf <- eigen_df_shift.rf1 |>
    tidyr::pivot_longer(1:6, names_to = 'sample', values_to = 'LFQvalue')

# Add a new column with groups KO or WT
eigen_df_long_shift.rf$group <- 'TOTALS_OCIAD1_KO'
eigen_df_long_shift.rf$group[grep('WT',eigen_df_long_shift.rf$sample)] <- 'TOTALS_OCIAD1_WT'

# Calculation of means for groups KO and WT
means <- eigen_df_long_shift.rf |>
  dplyr::group_by(group, protein.ids) |>
  dplyr::summarise(mean=mean(LFQvalue, na.rm=TRUE)) |>
    dplyr::ungroup()
...
# Preparing data for volcano plot
FC <- merge(means, eigen_df_shift.rf1, by = 'protein.ids')

to_volcano12 <- merge(FC, pvalue_eigen_shift.rf, by = 'protein.ids')
to_volcano12$sig_TOTALS_OCIAD1 <- ifelse(abs(to_volcano12$FC_OCIAD1)>FC.cutoff&
                                           to_volcano12$p_OCIAD1_TOTALS<p.cutoff,
                                       yes = TRUE, no = FALSE)
```

```{r v6 eigen}
# Plotting the volcano plot
output$V6eig <- renderPlotly({
    p.cutoff_sel <- as.numeric(input$p.cutoff)
    p.type <- input$p.type
    selected_gene <- input$gene
    adj_method <- input$adj.method
    
    selected_row <- which(to_volcano12$gene == selected_gene)
    if (length(selected_row) != 0) {
        sel_gene_data <- to_volcano12 |> dplyr::filter(gene == selected_gene)
        to_volcano <- to_volcano12[-selected_row,]
    } else {
        to_volcano <- to_volcano12
    }
...
```{r}
df2 <- lfq[which(miss_type$miss == 'complete'),-c(3,6)]

# calculate the p-values for our data
pvalue2 <- df2 |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(df2, 1, ttest, 
                  grp1=grep("KO", colnames(df2)), 
                  grp2=grep("WT", colnames(df2)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE),
                  protein.ids = protein.groups$`Protein IDs`[rows.to.keep][which(miss_type$miss == 'complete')])

# calculate the p-values for our data
imputed_shift.rf3 <- imputed_shift.rf[which(miss_type$miss == 'complete'),-c(3,6)]

pvalue_shift.rf2 <- imputed_shift.rf3 |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(imputed_shift.rf3, 1, ttest, 
                  grp1=grep("KO", colnames(imputed_shift.rf3)), 
                  grp2=grep("WT", colnames(imputed_shift.rf3)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE),
                  protein.ids = protein.groups$`Protein IDs`[rows.to.keep][which(miss_type$miss == 'complete')])
```
...
```{r}
# Preparing data for calculations
lfq2 <- cbind.data.frame(lfq[which(miss_type$miss == 'complete'),-c(3,6)], 
                        protein.ids=protein.groups$`Protein IDs`[rows.to.keep][which(miss_type$miss == 'complete')],
                        gene = protein.groups$`Gene names`[rows.to.keep][which(miss_type$miss == 'complete')])
lfq_long2 <- lfq2 |>
    tidyr::pivot_longer(1:4, names_to = 'sample', values_to = 'LFQvalue')

# Add a new column with groups KO or WT
lfq_long2$group <- 'TOTALS_OCIAD1_KO'
lfq_long2$group[grep('WT',lfq_long2$sample)] <- 'TOTALS_OCIAD1_WT'
...
means <- merge(means, miss_type[which(miss_type$miss == 'complete'),], by = 'protein.ids')

# Preparing data for volcano plot
FC <- merge(means, lfq2, by = 'protein.ids')

to_volcano15 <- merge(FC,pvalue2, by = 'protein.ids')
to_volcano15$sig_TOTALS_OCIAD1 <- ifelse(abs(to_volcano15$FC_OCIAD1)>FC.cutoff&
                                           to_volcano15$p_OCIAD1_TOTALS<p.cutoff,
                                         yes = TRUE, no = FALSE)
```

```{r}
# plotting the volcano plot
output$V15 <- renderPlotly({
    p.cutoff_sel <- as.numeric(input$p.cutoff)
    p.type <- input$p.type
    selected_gene <- input$gene
    adj_method <- input$adj.method
    
    selected_row <- which(to_volcano15$gene == selected_gene)
    if (length(selected_row) != 0) {
        sel_gene_data <- to_volcano15 |> dplyr::filter(gene == selected_gene)
        to_volcano <- to_volcano15[-selected_row,]
    } else {
        to_volcano <- to_volcano15
    }
...
```{r 111 fc shift.rf data}
# Preparing data for calculations
imputed_shift.rf2 <- cbind.data.frame(imputed_shift.rf[which(miss_type$miss == 'complete'),-c(3,6,7)],
                                      protein.ids=protein.groups$`Protein IDs`[rows.to.keep][which(miss_type$miss == 'complete')],
                                      gene = protein.groups$`Gene names`[rows.to.keep][which(miss_type$miss == 'complete')])

imputed_long_shift.rf2 <- imputed_shift.rf2 |>
    tidyr::pivot_longer(1:4, names_to = 'sample', values_to = 'LFQvalue')

# Add a new column with groups KO or WT
imputed_long_shift.rf2$group <- 'TOTALS_OCIAD1_KO'
imputed_long_shift.rf2$group[grep('WT',imputed_long_shift.rf2$sample)] <- 'TOTALS_OCIAD1_WT'

# Calculation of means for groups KO and WT
means <- imputed_long_shift.rf2 |>
    dplyr::group_by(group, protein.ids) |>
    dplyr::summarise(mean=mean(LFQvalue, na.rm=TRUE)) |>
    dplyr::ungroup()
...
# Preparing data for volcano plot
FC <- merge(means, imputed_shift.rf2, by = 'protein.ids')

to_volcano16 <- merge(FC, pvalue_shift.rf2, by = 'protein.ids')
to_volcano16$sig_TOTALS_OCIAD1 <- ifelse(abs(to_volcano16$FC_OCIAD1)>FC.cutoff&
                                           to_volcano16$p_OCIAD1_TOTALS<p.cutoff,
                                       yes = TRUE, no = FALSE)
```

```{r v16}
# Plotting the volcano plot
output$V16 <- renderPlotly({
    p.cutoff_sel <- as.numeric(input$p.cutoff)
    p.type <- input$p.type
    selected_gene <- input$gene
    adj_method <- input$adj.method
    
    selected_row <- which(to_volcano16$gene == selected_gene)
    if (length(selected_row) != 0) {
        sel_gene_data <- to_volcano16 |> dplyr::filter(gene == selected_gene)
        to_volcano <- to_volcano16[-selected_row,]
    } else {
        to_volcano <- to_volcano16
    }
...
```{r}
# prepare data for t-test
eigen_df2 <- data.frame(LFQ_KO.eigen, LFQ_WT.eigen)[which(miss_type$miss == 'complete'),-c(3,6)]

# calculate the p-values for our data
pvalue_eigen2 <- eigen_df2 |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(eigen_df2, 1, ttest, 
                  grp1=grep("KO", colnames(eigen_df2)), 
                  grp2=grep("WT", colnames(eigen_df2)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE),
                  protein.ids = protein.groups$`Protein IDs`[rows.to.keep][which(miss_type$miss == 'complete')])

# prepare data for t-test
eigen_df_shift.rf2 <- cbind.data.frame(LFQ_KO_shift.rf.eigen, LFQ_WT_shift.rf.eigen)[which(miss_type$miss == 'complete'),-c(3,6)]

# calculate the p-values for our data
pvalue_eigen_shift.rf2 <- eigen_df_shift.rf2 |>
    dplyr::mutate("p_OCIAD1_TOTALS" = apply(eigen_df_shift.rf2, 1, ttest, 
                  grp1=grep("KO", colnames(eigen_df_shift.rf2)), 
                  grp2=grep("WT", colnames(eigen_df_shift.rf2)))) |>
    dplyr::mutate(significant = ifelse(p_OCIAD1_TOTALS < p.cutoff, TRUE, FALSE),
                  protein.ids = protein.groups$`Protein IDs`[rows.to.keep][which(miss_type$miss == 'complete')])
```
...
```{r}
# Preparing data for calculations
lfq4 <- cbind.data.frame(eigen_df2, 
                        protein.ids=protein.groups$`Protein IDs`[rows.to.keep][which(miss_type$miss == 'complete')],
                        gene = protein.groups$`Gene names`[rows.to.keep][which(miss_type$miss == 'complete')])
lfq4_long <- lfq4 |>
    tidyr::pivot_longer(1:4, names_to = 'sample', values_to = 'LFQvalue')
...
# Add a new column with groups KO or WT
lfq4_long$group <- 'TOTALS_OCIAD1_KO'
lfq4_long$group[grep('WT',lfq4_long$sample)] <- 'TOTALS_OCIAD1_WT'
...
# Preparing data for volcano plot
FC <- merge(means, lfq4, by = 'protein.ids')

to_volcano17 <- merge(FC,pvalue_eigen2, by = 'protein.ids')
to_volcano17$sig_TOTALS_OCIAD1 <- ifelse(abs(to_volcano17$FC_OCIAD1)>FC.cutoff&
                                           to_volcano17$p_OCIAD1_TOTALS<p.cutoff,
                                       yes = TRUE, no = FALSE)
```

```{r}
# plotting the volcano plot
output$V17 <- renderPlotly({
    p.cutoff_sel <- as.numeric(input$p.cutoff)
    p.type <- input$p.type
    selected_gene <- input$gene
    adj_method <- input$adj.method
    
    selected_row <- which(to_volcano17$gene == selected_gene)
    if (length(selected_row) != 0) {
        sel_gene_data <- to_volcano17 |> dplyr::filter(gene == selected_gene)
        to_volcano <- to_volcano17[-selected_row,]
    } else {
        to_volcano <- to_volcano17
    }
...
```{r 233 fc shift.rf data}
# Preparing data for calculations
imputed_shift.rf3 <- cbind.data.frame(eigen_df_shift.rf[which(miss_type$miss == 'complete'),-c(3,6,7)],
                                      protein.ids=protein.groups$`Protein IDs`[rows.to.keep][which(miss_type$miss == 'complete')],
                                      gene = protein.groups$`Gene names`[rows.to.keep][which(miss_type$miss == 'complete')])

imputed_long_shift.rf3 <- imputed_shift.rf3 |>
    tidyr::pivot_longer(1:4, names_to = 'sample', values_to = 'LFQvalue')

# Add a new column with groups KO or WT
imputed_long_shift.rf3$group <- 'TOTALS_OCIAD1_KO'
imputed_long_shift.rf3$group[grep('WT',imputed_long_shift.rf3$sample)] <- 'TOTALS_OCIAD1_WT'

# Calculation of means for groups KO and WT
means <- imputed_long_shift.rf3 |>
    dplyr::group_by(group, protein.ids) |>
    dplyr::summarise(mean=mean(LFQvalue, na.rm=TRUE)) |>
    dplyr::ungroup()
...
means <- merge(means, miss_type[which(miss_type$miss == 'complete'),])

# Preparing data for volcano plot
FC <- merge(means, imputed_shift.rf3)

to_volcano18 <- merge(FC, pvalue_eigen_shift.rf2)
to_volcano18$sig_TOTALS_OCIAD1 <- ifelse(abs(to_volcano18$FC_OCIAD1)>FC.cutoff&
                                           to_volcano18$p_OCIAD1_TOTALS<p.cutoff,
                                       yes = TRUE, no = FALSE)
```

```{r v18}
# Plotting the volcano plot
output$V18 <- renderPlotly({
    p.cutoff_sel <- as.numeric(input$p.cutoff)
    p.type <- input$p.type
    selected_gene <- input$gene
    adj_method <- input$adj.method
    
    selected_row <- which(to_volcano18$gene == selected_gene)
    if (length(selected_row) != 0) {
        sel_gene_data <- to_volcano18 |> dplyr::filter(gene == selected_gene)
        to_volcano <- to_volcano18[-selected_row,]
    } else {
        to_volcano <- to_volcano18
    }
...
DT::datatable(
    rbind(Raw = table(to_volcano1$sig_TOTALS_OCIAD1),
          ...
          Shift.Dist = table(to_volcano2$sig_TOTALS_OCIAD1),
          Shift.Dist.Eigen = table(to_volcano8$sig_TOTALS_OCIAD1),
          RF = table(to_volcano3$sig_TOTALS_OCIAD1),
          RF.Eigen = table(to_volcano9$sig_TOTALS_OCIAD1),
          kNN = table(to_volcano4$sig_TOTALS_OCIAD1),
          kNN.Eigen = table(to_volcano10$sig_TOTALS_OCIAD1),
          Ludovic = table(to_volcano5$sig_TOTALS_OCIAD1),
          Ludovic.Eigen = table(to_volcano11$sig_TOTALS_OCIAD1),
          Shift.RF = table(to_volcano6$sig_TOTALS_OCIAD1),
          Shift.RF.Eigen = table(to_volcano12$sig_TOTALS_OCIAD1)),
    options=list(searching=FALSE, paging=FALSE, info=FALSE)
)
```
...
protein.groups_ludovic_raw$`LFQ intensity KO_TOTALS_22` <- imputed_ludovic_correct$KO.22
protein.groups_ludovic_raw$`LFQ intensity KO_TOTALS_23` <- imputed_ludovic_correct$KO.23
protein.groups_ludovic_raw$`LFQ intensity KO_TOTALS_24` <- imputed_ludovic_correct$KO.24
protein.groups_ludovic_raw$`LFQ intensity WT_TOTALS_22` <- imputed_ludovic_correct$WT.22
protein.groups_ludovic_raw$`LFQ intensity WT_TOTALS_23` <- imputed_ludovic_correct$WT.23
protein.groups_ludovic_raw$`LFQ intensity WT_TOTALS_24` <- imputed_ludovic_correct$WT.24
...
protein.groups_ludovic_eigenms$`LFQ intensity KO_TOTALS_22` <- eigen_ludovic_clean$KO.22
protein.groups_ludovic_eigenms$`LFQ intensity KO_TOTALS_23` <- eigen_ludovic_clean$KO.23
protein.groups_ludovic_eigenms$`LFQ intensity KO_TOTALS_24` <- eigen_ludovic_clean$KO.24
protein.groups_ludovic_eigenms$`LFQ intensity WT_TOTALS_22` <- eigen_ludovic_clean$WT.22
protein.groups_ludovic_eigenms$`LFQ intensity WT_TOTALS_23` <- eigen_ludovic_clean$WT.23
protein.groups_ludovic_eigenms$`LFQ intensity WT_TOTALS_24` <- eigen_ludovic_clean$WT.24
```

```{r}
write.table(protein.groups_ludovic_raw, file='proteingroups_ludovic_raw.txt', sep='\t', row.names = FALSE)

write.table(protein.groups_ludovic_eigenms, file='proteingroups_ludovic_eigenms.txt', sep='\t', row.name=FALSE)
```
