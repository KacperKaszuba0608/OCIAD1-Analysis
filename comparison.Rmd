...
```{r}
qvalue <- qvalue::qvalue(pvalue$p_OCIAD1_TOTALS)

qvalue_imp <- qvalue::qvalue(pvalue_imp$p_OCIAD1_TOTALS)

qvalue_RF <- qvalue::qvalue(pvalue_RF$p_OCIAD1_TOTALS)

qvalue_kNN <- qvalue::qvalue(pvalue_kNN$p_OCIAD1_TOTALS)

qvalue_ludovic <- qvalue::qvalue(pvalue_ludovic$p_OCIAD1_TOTALS)

qvalue_shift.rf <- qvalue::qvalue(pvalue_shift.rf$p_OCIAD1_TOTALS)
```
...
```{r}
plot(qvalue_shift.rf)
```

### Z-Score {.tabset}

```{r}
qvalue.standard <- qvalue::qvalue(pvalue_standard$p_OCIAD1_TOTALS)

qvalue_imp.standard <- qvalue::qvalue(pvalue_standard_imp$p_OCIAD1_TOTALS)

qvalue_RF.standard <- qvalue::qvalue(pvalue_standard_RF$p_OCIAD1_TOTALS)

qvalue_kNN.standard <- qvalue::qvalue(pvalue_standard_kNN$p_OCIAD1_TOTALS)

qvalue_ludovic.standard <- qvalue::qvalue(pvalue_standard_ludovic$p_OCIAD1_TOTALS)

qvalue_shift.rf.standard <- qvalue::qvalue(pvalue_standard_shift.rf$p_OCIAD1_TOTALS)
```
#### Non-Imputed

```{r}
plot(qvalue.standard)
```

#### Shift Dist

```{r}
plot(qvalue_imp.standard)
```

#### Random Forest

```{r}
plot(qvalue_RF.standard)
```

#### k-Nearest Neighbors

```{r}
plot(qvalue_kNN.standard)
```

#### Ludovic

```{r}
plot(qvalue_ludovic.standard)
```

#### Shift Dist & RF

```{r}
plot(qvalue_shift.rf.standard)
```

### Min-Max {.tabset}

```{r}
qvalue.minmax <- qvalue::qvalue(pvalue_minmax$p_OCIAD1_TOTALS)

qvalue_imp.minmax <- qvalue::qvalue(pvalue_minmax_imp$p_OCIAD1_TOTALS)

qvalue_RF.minmax <- qvalue::qvalue(pvalue_minmax_RF$p_OCIAD1_TOTALS)

qvalue_kNN.minmax <- qvalue::qvalue(pvalue_minmax_kNN$p_OCIAD1_TOTALS)

qvalue_ludovic.minmax <- qvalue::qvalue(pvalue_minmax_ludovic$p_OCIAD1_TOTALS)

qvalue_shift.rf.minmax <- qvalue::qvalue(pvalue_minmax_shift.rf$p_OCIAD1_TOTALS)
```
...
```{r}
plot(qvalue_imp.minmax)
```

#### Random Forest

```{r}
plot(qvalue_RF.minmax)
```

#### k-Nearest Neighbors

```{r}
plot(qvalue_kNN.minmax)
```

#### Ludovic

```{r}
plot(qvalue_ludovic.minmax)
```

#### Shift Dist & RF

```{r}
plot(qvalue_shift.rf.minmax)
```

### Median Scaling {.tabset}

```{r}
qvalue.med <- qvalue::qvalue(pvalue_med$p_OCIAD1_TOTALS)

qvalue_imp.med <- qvalue::qvalue(pvalue_med_imp$p_OCIAD1_TOTALS)

qvalue_RF.med <- qvalue::qvalue(pvalue_med_RF$p_OCIAD1_TOTALS)

qvalue_kNN.med <- qvalue::qvalue(pvalue_med_kNN$p_OCIAD1_TOTALS)

qvalue_ludovic.med <- qvalue::qvalue(pvalue_med_ludovic$p_OCIAD1_TOTALS)

qvalue_shift.rf.med <- qvalue::qvalue(pvalue_med_shift.rf$p_OCIAD1_TOTALS)
```
...
```{r}
plot(qvalue_ludovic.med)
```

#### Shift Dist & RF

```{r}
plot(qvalue_shift.rf.med)
```

### MAD Scaling {.tabset}

```{r}
qvalue.mad <- qvalue::qvalue(pvalue_mad$p_OCIAD1_TOTALS)

qvalue_imp.mad <- qvalue::qvalue(pvalue_mad_imp$p_OCIAD1_TOTALS)

qvalue_RF.mad <- qvalue::qvalue(pvalue_mad_RF$p_OCIAD1_TOTALS)

qvalue_kNN.mad <- qvalue::qvalue(pvalue_mad_kNN$p_OCIAD1_TOTALS)

qvalue_ludovic.mad <- qvalue::qvalue(pvalue_mad_ludovic$p_OCIAD1_TOTALS)

qvalue_shift.rf.mad <- qvalue::qvalue(pvalue_mad_shift.rf$p_OCIAD1_TOTALS)
```
...
```{r}
plot(qvalue_ludovic.mad)
```

#### Shift Dist & RF

```{r}
plot(qvalue_shift.rf.mad)
```

### Linear Regression {.tabset}

```{r}
qvalue.lm <- qvalue::qvalue(pvalue_lm$p_OCIAD1_TOTALS)

qvalue_imp.lm <- qvalue::qvalue(pvalue_lm_imp$p_OCIAD1_TOTALS)

qvalue_RF.lm <- qvalue::qvalue(pvalue_lm_RF$p_OCIAD1_TOTALS)

qvalue_kNN.lm <- qvalue::qvalue(pvalue_lm_kNN$p_OCIAD1_TOTALS)

qvalue_ludovic.lm <- qvalue::qvalue(pvalue_lm_ludovic$p_OCIAD1_TOTALS)

qvalue_shift.rf.lm <- qvalue::qvalue(pvalue_lm_shift.rf$p_OCIAD1_TOTALS)
```
...
```{r}
plot(qvalue_ludovic.lm)
```

#### Shift Dist & RF

```{r}
plot(qvalue_shift.rf.lm)
```

### VSN {.tabset}

```{r}
qvalue.vsn <- qvalue::qvalue(pvalue_vsn$p_OCIAD1_TOTALS)

qvalue_imp.vsn <- qvalue::qvalue(pvalue_vsn_imp$p_OCIAD1_TOTALS)

qvalue_RF.vsn <- qvalue::qvalue(pvalue_vsn_RF$p_OCIAD1_TOTALS)

qvalue_kNN.vsn <- qvalue::qvalue(pvalue_vsn_kNN$p_OCIAD1_TOTALS)

qvalue_ludovic.vsn <- qvalue::qvalue(pvalue_vsn_ludovic$p_OCIAD1_TOTALS)

qvalue_shift.rf.vsn <- qvalue::qvalue(pvalue_vsn_shift.rf$p_OCIAD1_TOTALS)
```
...
```{r}
plot(qvalue_ludovic.vsn)
```

#### Shift Dist & RF

```{r}
plot(qvalue_shift.rf.vsn)
```

### EigenMS {.tabset}

```{r}
qvalue.eigen <- qvalue::qvalue(pvalue_eigen$p_OCIAD1_TOTALS)

qvalue_imp.eigen <- qvalue::qvalue(pvalue_eigen_imp$p_OCIAD1_TOTALS)

qvalue_RF.eigen <- qvalue::qvalue(pvalue_eigen_RF$p_OCIAD1_TOTALS)

qvalue_kNN.eigen <- qvalue::qvalue(pvalue_eigen_kNN$p_OCIAD1_TOTALS)

qvalue_ludovic.eigen <- qvalue::qvalue(pvalue_eigen_ludovic$p_OCIAD1_TOTALS)

qvalue_shift.rf.eigen <- qvalue::qvalue(pvalue_eigen_shift.rf$p_OCIAD1_TOTALS)
```
...
```{r}
plot(qvalue_imp.eigen)
```

#### Random Forest

```{r}
plot(qvalue_RF.eigen)
```

#### k-Nearest Neighbors

```{r}
plot(qvalue_kNN.eigen)
```

#### Ludovic

```{r}
plot(qvalue_ludovic.eigen)
```

#### Shift Dist & RF

```{r}
plot(qvalue_shift.rf.eigen)
```
# Raw VS Normalized     
...
lfq <- cbind.data.frame(lfq, protein.ids=protein.groups$`Protein IDs`[rows.to.keep])
lfq_long <- lfq |>
...
means <- merge(means, miss_type)

# Preparing data for volcano plot
FC <- merge(means, lfq)
FC <- FC |> dplyr::mutate(gene = protein.groups$`Gene names`[rows.to.keep])
...
```{r fc shift.rf data}
# Preparing data for calculations
imputed_shift.rf <- cbind.data.frame(imputed_shift.rf[,1:6], 
                                    protein.ids=protein.groups$`Protein IDs`[rows.to.keep])
imputed_long_shift.rf <- imputed_shift.rf |>
    tidyr::pivot_longer(1:6, names_to = 'sample', values_to = 'LFQvalue')
...
# Preparing data for volcano plot
FC <- merge(means, imputed_shift.rf)
FC <- FC |> dplyr::mutate(gene = protein.groups$`Gene names`[rows.to.keep])

to_volcano6 <- merge(FC, pvalue_shift.rf)
...
to_volcano7 <- merge(FC,pvalue_eigen)
...
to_volcano8 <- merge(FC, pvalue_eigen_imp)
...
to_volcano9 <- merge(FC, pvalue_eigen_RF)
...
to_volcano10 <- merge(FC, pvalue_eigen_kNN)
...
to_volcano11 <- merge(FC, pvalue_eigen_ludovic)
...
# Preparing data for calculations
eigen_df_shift.rf <- cbind.data.frame(eigen_df_shift.rf, 
                                     protein.ids=protein.groups$`Protein IDs`[rows.to.keep])
eigen_df_long_shift.rf <- eigen_df_shift.rf |>
    tidyr::pivot_longer(1:6, names_to = 'sample', values_to = 'LFQvalue')
...
# Preparing data for volcano plot
FC <- merge(means, eigen_df_shift.rf)
FC <- FC |> dplyr::mutate(gene = protein.groups$`Gene names`[rows.to.keep])

to_volcano12 <- merge(FC, pvalue_eigen_shift.rf)
