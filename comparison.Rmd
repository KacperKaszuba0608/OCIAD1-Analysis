...
output$V1 <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
        ...
        layout(title = 'Volcano plot for Non-Imputed Data',
...
output$V2 <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = 'Volcano plot for Imputed Data - Shift Dist',
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = '-log10(p-value)'),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
...
output$V3 <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         hoverinfo = list('text', 'symbol'),  # Show labels on hover
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = 'Volcano plot for Imputed Data - RF',
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = '-log10(p-value)'),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
...
output$V4 <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         hoverinfo = list('text', 'symbol'),  # Show labels on hover
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = 'Volcano plot for Imputed Data - kNN',
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = '-log10(p-value)'),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
...
output$V5 <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = 'Volcano plot for Imputed Data - Ludovic',
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = '-log10(p-value)'),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
...
output$V3eig <- renderPlotly({
    ...
    v <- plotly::plot_ly(data = to_volcano, 
                         ...
                         hoverinfo = list('text', 'symbol'),  # Show gene labels on hover
                         marker = list(size = 5)) |>  # Adjust marker size as needed
        layout(title = 'Volcano plot for Imputed Data - Random Forest',
               xaxis = list(title = 'log2(fold change)'),
               yaxis = list(title = '-log10(p-value)'),
               shapes = list(
                   list(type = 'line', x0 = -1, x1 = -1, y0 = 0, y1 = max(-log10(to_volcano$p_OCIAD1_TOTALS)), 
