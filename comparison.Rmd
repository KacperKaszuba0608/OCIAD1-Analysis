...
to_plot_KO22 <- rbind.data.frame(to_plot_KO22.1, to_plot_KO22.2, to_plot_KO22.3,
                                 to_plot_KO22.4, to_plot_KO22.5, to_plot_KO22.6,
                                 to_plot_KO22.7)
rm(to_plot_KO22.1, to_plot_KO22.2, to_plot_KO22.3, to_plot_KO22.4, to_plot_KO22.5,
   to_plot_KO22.6, to_plot_KO22.7, ludovic_ids, raw_ids)
```
...
to_plot_KO23 <- rbind.data.frame(to_plot_KO23.1, to_plot_KO23.2, to_plot_KO23.3,
                                 to_plot_KO23.4, to_plot_KO23.5, to_plot_KO23.6,
                                 to_plot_KO23.7)
rm(to_plot_KO23.1, to_plot_KO23.2, to_plot_KO23.3, to_plot_KO23.4, to_plot_KO23.5,
   to_plot_KO23.6, to_plot_KO23.7, ludovic_ids, raw_ids)
```
...
to_plot_KO24 <- rbind.data.frame(to_plot_KO24.1, to_plot_KO24.2, to_plot_KO24.3,
                                 to_plot_KO24.4, to_plot_KO24.5, to_plot_KO24.6,
                                 to_plot_KO24.7)
rm(to_plot_KO24.1, to_plot_KO24.2, to_plot_KO24.3, to_plot_KO24.4, to_plot_KO24.5,
   to_plot_KO24.6, to_plot_KO24.7, ludovic_ids, raw_ids)
```
...
to_plot_WT22 <- rbind.data.frame(to_plot_WT22.1, to_plot_WT22.2, to_plot_WT22.3,
                                 to_plot_WT22.4, to_plot_WT22.5, to_plot_WT22.6,
                                 to_plot_WT22.7)
rm(to_plot_WT22.1, to_plot_WT22.2, to_plot_WT22.3, to_plot_WT22.4, to_plot_WT22.5,
   to_plot_WT22.6, to_plot_WT22.7, ludovic_ids, raw_ids)
```
...
to_plot_WT23 <- rbind.data.frame(to_plot_WT23.1, to_plot_WT23.2, to_plot_WT23.3,
                                 to_plot_WT23.4, to_plot_WT23.5, to_plot_WT23.6,
                                 to_plot_WT23.7)
rm(to_plot_WT23.1, to_plot_WT23.2, to_plot_WT23.3, to_plot_WT23.4, to_plot_WT23.5,
   to_plot_WT23.6, to_plot_WT23.7, ludovic_ids, raw_ids)
```
...
to_plot_WT24 <- rbind.data.frame(to_plot_WT24.1, to_plot_WT24.2, to_plot_WT24.3,
                                 to_plot_WT24.4, to_plot_WT24.5, to_plot_WT24.6,
                                 to_plot_WT24.7)
rm(to_plot_WT24.1, to_plot_WT24.2, to_plot_WT24.3, to_plot_WT24.4, to_plot_WT24.5,
   to_plot_WT24.6, to_plot_WT24.7, ludovic_ids, raw_ids)
```
...
to_plot_all <- rbind(to_plot_KO22,
                     ...
                     to_plot_KO24,
                     to_plot_WT23)
to_plot_all$celltype <- rep(c('KO.22', 'WT.22', 'KO.23', 'WT.23', 'KO.24', 'WT.24'), each = 41335)
```
...
output$lfq.all.Plot <- renderPlotly({
    ...
    # add raw histogram based on the user selection
    if (selected_data == 'original') {
        p |> add_trace(data = lfq, x = ~.data[[selected_cell]], name='Raw data')
    } else if (selected_data == 'shift_dist') {
        selected_cell <- gsub('\\.', '.I.', selected_cell)
        p |> add_trace(data = lfq_imp, x = ~.data[[selected_cell]], name='Raw imp data')
    } else if (selected_data == 'ludovic') {
        selected_cell <- gsub('\\.', '_', selected_cell)
        p |> add_trace(data = imputed_ludovic, x = ~.data[[selected_cell]], name='Raw ludovic data')
    } else if (selected_data == 'rf') {
        p |> add_trace(data = imputed_RF, x = ~.data[[selected_cell]], name='Raw RF data')
    } else if (selected_data == 'knn') {
        p |> add_trace(data = imputed_kNN, x = ~.data[[selected_cell]], name='Raw kNN data')
    }
})
```
