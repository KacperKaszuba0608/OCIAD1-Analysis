...
lud_prots_to_keep <- which(rownames(eigen_df_ludovic) %in% rownames(eigen_df))

# Create a data frame to make interactive plot
data <- data.frame(
    Gene_Name = rep(protein.groups$`Gene names`[miss], each=6),
    lfq[miss,1:6] |> 
